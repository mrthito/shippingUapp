            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div class="nav-item">
                            <a class="nav-link " href="./layouts/" data-placement="left">
                        ...
                        <div class="nav-item">
                            <a class="nav-link " href="./documentation/" data-placement="left">
    ...
    <main id="content" role="main" class="main">
        ...
        <div class="footer">
            <div class="row justify-content-between align-items-center">
                <div class="col">
                    <p class="fs-6 mb-0">&copy; Front. <span class="d-none d-sm-inline-block">2024
                            Htmlstream.</span></p>
                </div>
                <!-- End Col -->
